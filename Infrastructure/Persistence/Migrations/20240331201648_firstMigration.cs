    ...
    public partial class firstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "c/las torres", "Zaragoza", "boston" },
                    { 2L, "c/los olmos", "Madrid", "altamira" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Name", "Password", "Role", "Surname" },
                values: new object[,]
                {
                    { 1L, "alberto", "root", "Admin", "salas" },
                    { 2L, "ana", "root", "Admin", "sanz" }
                });

            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "HotelId", "Storey", "Type" },
                values: new object[,]
                {
                    { 1L, 1L, 1, "Single" },
                    { 2L, 1L, 1, "Single" },
